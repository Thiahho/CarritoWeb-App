...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active"><a class="navbar-brand" href="index.jsp">Home
        </a>
      </li>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="allPantalones.jsp">Pantalones</a>
      </li>
    ...
    <form class="form-inline my-2 my-lg-0">
    	<a href="perfil.jsp" class="btn btn-light my-2 my-sm-0" ><i class="fa-solid fa-user"></i> Perfil</a>
